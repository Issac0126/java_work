...
public class MainClass {
	...
	public static void main(String[] args) {
        ...
        */
		...
		System.out.println("길이가 5인 정사각형의 넓이: "+square.calcRectArea(5)+"㎠");
		System.out.println("가로10, 세로20 인 직사각형의 넓이: "+square.calcRectArea(10, 20)+"㎠");
		System.out.println("윗변5, 밑변13, 높이7 인 사다리꼴의 넓이: "+square.calcRectArea(5,13,7)+"㎠");
