...
//		Inter i1 = new Inter();  (x)
		...
		it1.method1();
//		it1.method2();  method2는 Inter2에 있기 때문에(Inter의 자식클래스) 확인되지 않음. 
//		it1.method3();	ImplClass1안에 있는 메서드가 Inter 안에 있을리가 없음. 
		it1.parentMethod();
//		(ImplClass1) it1.method2(); // .과 괄호 중 온전(.)이 우선시된다.  
			//그래서 연산 우선순위상 (ImplClass1) it1.method2();는 에러가 난다. 
		((ImplClass1) it1).method2();
		//연산자의 우선 순위: 괄호() -> 참조(.) -> 단항 -> 2항-> 3항 -> 대입 
